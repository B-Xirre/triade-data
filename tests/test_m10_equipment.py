    ...
    def test_seed_has_locked_m10_equipment_shape(self) -> None:
        ...
        self.assertEqual(
            totals,
            {
                ...
                "martial.dagger": 3,
                "martial.sword_1h": 3,
                "martial.shield_standard": 1,
                "martial.mace_1h": 3,
            },
        )
        self.assertEqual(self.seed["Defence_profile_entries"][0]["rating_value"], 1)
        self.assertEqual(self.seed["Defence_profile_entries"][0]["rating_unit"], "pip")
    ...
    def test_apply_is_exact_idempotent_and_preserves_dependencies(self) -> None:
        with tempfile.TemporaryDirectory() as directory:
            ...
            try:
                ...
                self.assertTrue(first["shield_pool_verified"])
